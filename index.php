...
<html lang="en">
    <head>
        ...
        <title>Freelancer - Inicio de tema bootstrap</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Iniciar Bootstrap</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Artista Grafico - Diseñador Web - Illustrador</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Portafolios</h2>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Freelancer es un tema de arranque gratuito creado por Start Bootstrap. La descarga incluye los archivos fuente completos, incluidos HTML, CSS y JavaScript, así como hojas de estilo SASS opcionales para una fácil personalización.</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">¡Puedes crear tu propio avatar personalizado para la cabecera, cambiar el ícono en los divisores y agregar tu dirección de correo electrónico al formulario de contacto para que sea completamente funcional!</p></div>
                </div>
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Numero telefonico requerido.</div>
                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
